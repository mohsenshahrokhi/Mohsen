                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex items-center mt-4 gap-x-3">
                        ...
                        <TERipple rippleColor="white">
                            <Link id="addProduct" href={'/dashboard/gallery/addFile'} type="button" className="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                    ...
                    <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                            <div className=" grid grid-cols-1 md:grid-cols-12 p-5 gap-2 overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                {gallerys.length > 0 && gallerys.map((gallery) => (<div className='flex' key={gallery._id}>
                                        <div className=" flex text-center justify-center">
                                            <div className="flex flex-col border">
                                                <div className="p-2 md:flex-shrink-0">
                                                    <Image src={`/uploads/${gallery.url}`} width="148" height="199" priority={true} alt="Woman paying for a purchase" className="rounded-lg"/>
                                                </div>
                                                <div className="mt-4">
