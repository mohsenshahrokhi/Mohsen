...
import { Box, Button, FormControl, FormControlLabel, FormHelperText, IconButton, InputAdornment, InputLabel, OutlinedInput, styled } from '@mui/material';
...
function AddSettings({ params, searchParams }) {
    ...
    const onSubmit = (values) => {
        ...
        form.setValue('author', user === null || user === void 0 ? void 0 : user._id);
    ...
    return (<Box component="div" sx={{ m: '2px', width: '100%', justifyContent: 'center' }}>
            <Fab size="medium" variant="extended" color="secondary" aria-label="add">
                <Link href={`/dashboard/siteSettings/${url}`}>
                    انصراف
                </Link>
            </Fab>
            ...
            {...field} autoComplete='name' disabled={isPending} 
            // onInvalid={true}
            error={fieldState.error ? true : false} type={'text'} startAdornment={<InputAdornment position="start">
                ...
                edge="start">
                                        ...
                                        </InputAdornment>} label="نام دسته بندی" fullWidth/>
                                {/* <Input
            ...
            /> */}
                    ...
                    <Controller name="latinName" control={form.control} render={({ field, fieldState }) => {
            var _a, _b;
            return (<FormControl component="div" fullWidth sx={{ my: 1 }} variant="outlined">
                                <InputLabel htmlFor="latinName">نام لاتین دسته بندی</InputLabel>
                                <OutlinedInput id='latinName' {...field} autoComplete='name' disabled={isPending} error={fieldState.error ? true : false} type={'text'} label="نام لاتین دسته بندی" fullWidth startAdornment={<InputAdornment position="start">
...
//# sourceMappingURL=page00.js.map